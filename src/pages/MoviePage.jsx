...
function MoviePage() {
  ...
  return (
    <div className='bg-#151922-700 min-h-[100vh] text-white text-3xl sm:text-4xl md:text-3xl lg:text-4xl xl:text-6xl font-bold'>
      {width < 768 ? (
        <NavBar />
      ) : (
        <img
            ...
            >
              <div className='relative flex-shrink-0 h-[180px] md:h-[250px] lg:h-[300px] aspect-video rounded-xl'>
                ...
                <img
                  src={play_icon}
                  alt='play icon'
                  className='bg-transparent absolute inset-0 w-[150px] h-[150px] m-auto'
                />
              </div>
